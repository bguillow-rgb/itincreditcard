...
relatedQueries:
  - "mejor tarjeta de crédito para titular de ITIN sin historial en EE.UU."
  - "tarjeta de crédito fácil de obtener con ITIN sin historial crediticio"
  - "cómo empezar a construir crédito con número ITIN"
  - "qué tarjeta de crédito pedir primero con un ITIN"
  - "tarjeta de crédito con ITIN sin verificación de crédito y sin depósito"
quickAnswer: "Las mejores tarjetas de crédito para titulares de ITIN sin historial crediticio en EE.UU. son la Capital One Quicksilver Secured (depósito de $200, 1.5% de reembolso en efectivo, sin cuota anual), la OpenSky Secured Visa (sin verificación de crédito, depósito mínimo de $200) y la Chase Freedom Rise (sin garantía, acepta ITIN, 1.5% de reembolso). Las tres reportan a las tres principales agencias de crédito y pueden generar tu primer puntaje FICO en aproximadamente seis meses."
...
faqs:
  ...
  - q: "¿Cuánto tiempo tarda en aparecer un puntaje de crédito después de abrir mi primera tarjeta con ITIN?"
    a: "VantageScore puede generar tu primer puntaje después de aproximadamente un mes de actividad. FICO requiere un mínimo de seis meses de historial reportado. La mayoría de los titulares de ITIN que parten desde cero ven su primer puntaje FICO utilizable entre el cuarto y el sexto mes."
  - q: "¿Cuál es el depósito mínimo para una tarjeta asegurada con ITIN?"
    a: "La mayoría de las tarjetas aseguradas requieren un depósito mínimo de $200. La tarjeta Launch de OpenSky acepta depósitos desde $100. El depósito es totalmente reembolsable cuando cierras la cuenta en buen estado o pasas a una tarjeta sin garantía."
  - q: "¿Las tarjetas de crédito iniciales con ITIN reportan a las tres agencias de crédito?"
    a: "Las mejores sí lo hacen. Capital One, Citi, Chase y OpenSky reportan a Equifax, Experian y TransUnion cada mes. Siempre confirma el reporte a las agencias antes de solicitar, porque algunas tarjetas fintech solo reportan a una o dos."
  - q: "¿La Chase Freedom Rise está disponible para titulares de ITIN sin historial crediticio?"
    a: "Sí. Chase acepta explícitamente un ITIN en lugar de un SSN en la solicitud de la Freedom Rise. Al aplicar en línea, selecciona \"Individual Tax ID number\" en el campo \"Tax ID type\". Tener una cuenta de cheques en Chase con al menos $250 mejora significativamente las probabilidades de aprobación."
  - q: "¿Qué puntaje de crédito tendré después de 12 meses de uso responsable de una tarjeta con ITIN?"
    a: "La mayoría de los titulares de ITIN que parten desde cero alcanzan un puntaje regular (580-669) en 4-6 meses y un puntaje bueno (670-739) en 12-18 meses, siempre que realicen pagos a tiempo y mantengan una utilización baja."
  - q: "¿Puedo pasar de una tarjeta asegurada con ITIN a una tarjeta sin garantía?"
    a: "Sí. Capital One revisa a sus tarjetahabientes para una mejora cada seis meses. OpenSky invita a los tarjetahabientes elegibles a la Visa Gold sin garantía después de aproximadamente seis meses de pagos puntuales. La ruta de mejora de Citi actualmente requiere un SSN, por lo que los titulares solo de ITIN puede que necesiten esperar hasta obtener uno."
  - q: "¿Solicitar varias tarjetas iniciales al mismo tiempo afecta mi puntaje de crédito?"
    a: "La mayoría de las solicitudes de tarjetas aseguradas generan una consulta dura (hard inquiry), que puede bajar tu puntaje temporalmente algunos puntos. Solicita una sola tarjeta primero, úsala durante seis meses y luego considera una segunda. OpenSky y algunas opciones fintech omiten la consulta dura."
  - q: "¿Qué documentos necesito para solicitar una tarjeta de crédito inicial con ITIN?"
    a: "Por lo general necesitas tu ITIN (la carta de asignación del IRS), un pasaporte extranjero o identificación oficial con foto, una dirección postal en EE.UU. y una cuenta bancaria en EE.UU. para financiar el depósito de seguridad requerido. Algunos emisores también piden comprobante de ingresos."
  - q: "¿Existen tarjetas de crédito iniciales con ITIN sin cuota anual y sin depósito de seguridad?"
    a: "Sí. La Chase Freedom Rise es una tarjeta sin garantía, sin cuota anual, que acepta ITIN. La Current Build Card tampoco cobra cuota anual ni exige un depósito de seguridad tradicional, aunque está vinculada al saldo de una cuenta de gastos de Current."
published: true
---
...
| Característica | Citi Secured Mastercard | Self Visa Credit Card |
|---|---|---|
| Acepta ITIN | Sí | Sí |
...
| Ruta de mejora a tarjeta sin garantía | Requiere SSN | Ruta disponible solo con la tarjeta |
...
| Hito | Tiempo típico desde la apertura de la tarjeta |
|---|---|
| Aparece el primer VantageScore | 1 mes |
| Se genera el primer puntaje FICO | 4-6 meses |
| Rango de crédito regular (580-669) | 4-6 meses |
| Rango de crédito bueno (670-739) | 12-18 meses |
| Elegible para mejora a tarjeta sin garantía | 6-12 meses (depende del emisor) |
...
Una vez que tengas 6-12 meses de historial limpio y un puntaje en el rango regular a bueno, considera opciones sin garantía. Nuestras guías sobre [tarjetas de crédito sin garantía para titulares de ITIN](https://itincreditcard.com/unsecured-credit-card-itin-holders) y [cómo pasar de una tarjeta asegurada a una sin garantía con un ITIN](https://itincreditcard.com/upgrade-secured-to-unsecured-credit-card-itin) cubren ese siguiente paso en detalle.
...
¿Puedo obtener una tarjeta de crédito inicial con solo un ITIN y sin historial crediticio en EE.UU.?
Sí. Capital One, Citi, OpenSky y Chase aceptan explícitamente un ITIN en lugar de un SSN. Las tarjetas aseguradas son el punto de entrada más fácil porque la aprobación depende de tu depósito, no de un historial crediticio previo en EE.UU.

¿Cuánto tiempo tarda en aparecer un puntaje FICO después de abrir mi primera tarjeta con ITIN?
Construir un nuevo historial puede tomar hasta seis meses, y para el puntaje FICO, se necesita un mínimo de seis meses para ver resultados. VantageScore puede aparecer después de solo un mes, pero la mayoría de los prestamistas dependen del FICO.

¿Cuál es el depósito mínimo para una tarjeta asegurada con ITIN?
Los depósitos pueden variar desde tan poco como $150 hasta $3,000, según la tarjeta que elijas. La mayoría de las tarjetas aseguradas estándar comienzan en $200. La variante Launch de OpenSky acepta depósitos desde $100.

¿Las tarjetas iniciales con ITIN reportan a las tres agencias de crédito?
Las mejores sí lo hacen. Capital One, Citi, Chase y OpenSky reportan a Equifax, Experian y TransUnion mensualmente. Siempre confirma el reporte a las agencias antes de solicitar.

¿La Chase Freedom Rise está disponible para titulares de ITIN sin historial crediticio?
Sí. Puedes obtener la Chase Freedom Rise sin un SSN, siempre que tengas un ITIN. Chase requiere una de estas formas de identificación. Para usar tu ITIN al solicitar en línea, selecciona "Individual Tax ID number" en el campo "Tax ID type" de la solicitud.

¿Qué puntaje de crédito puedo esperar después de 12 meses de uso responsable de una tarjeta con ITIN?
Alcanzar un puntaje regular (580-669) normalmente toma 4-6 meses de pagos puntuales. Un puntaje bueno (670-739) generalmente toma 12-18 meses de comportamiento consistente.

¿Puedo pasar de una tarjeta asegurada con ITIN a una tarjeta sin garantía?
Capital One revisa automáticamente a los tarjetahabientes para una línea de crédito más alta cada seis meses. Una vez que tu crédito haya mejorado, puedes pasar a una Capital One Quicksilver sin garantía y recibir de vuelta tu depósito de seguridad. OpenSky ofrece una ruta de mejora similar después de aproximadamente seis meses. La mejora de Citi actualmente requiere un SSN.

¿Solicitar una tarjeta inicial afecta mi puntaje de crédito?
La mayoría de las solicitudes de tarjetas aseguradas implican una consulta dura, que puede bajar temporalmente tu puntaje algunos puntos. OpenSky y la Current Build Card omiten la consulta dura. Solicita una tarjeta a la vez y espera al menos seis meses antes de buscar crédito adicional.

¿Qué documentos necesito para solicitar con un ITIN?
Necesitas un ITIN válido, un pasaporte extranjero, una dirección postal en EE.UU. y una cuenta bancaria en EE.UU. para financiar cualquier depósito de seguridad. Algunos emisores también requieren comprobante de ingresos.

¿Existen tarjetas iniciales con ITIN sin cuota anual y sin depósito de seguridad?
Sí. La Chase Freedom Rise no tiene cuota anual y no requiere depósito. La Current Build Card es otra opción: no hay verificación de crédito, no hay depósito de seguridad mínimo y el APR es 0%, por lo que la aprobación no depende de un historial crediticio en EE.UU. que aún no tienes.
