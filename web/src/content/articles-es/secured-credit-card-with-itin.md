...
relatedQueries:
  - "cómo solicitar una tarjeta de crédito con ITIN"
  - "tarjetas de crédito que aceptan ITIN"
  - "mejor tarjeta de crédito asegurada para inmigrantes sin SSN"
...
faqs:
  ...
  - q: "¿Cuánto depósito necesito para una tarjeta de crédito asegurada con ITIN?"
    a: "La mayoría de las tarjetas aseguradas requieren un depósito reembolsable de entre $200 y $500, que se convierte en tu límite de crédito. La Capital One Platinum Secured está disponible con depósitos desde $49, $99 o $200, según tu perfil crediticio. El depósito se devuelve cuando pasas a una tarjeta sin garantía o cierras la cuenta al día."
  - q: "¿Usar un ITIN en lugar de un SSN afecta mi puntaje de crédito?"
    a: "No. Las agencias de crédito construyen y calculan tu expediente exactamente de la misma manera, independientemente de si usaste un ITIN o un SSN para abrir la cuenta. El historial de pagos, el porcentaje de uso, la antigüedad del crédito y la combinación de productos funcionan de manera idéntica."
  - q: "¿Cuánto tiempo tarda en convertirse mi tarjeta asegurada en una tarjeta sin garantía?"
    a: "La mayoría de los emisores revisan tu cuenta para un posible ascenso después de 6 a 12 meses de pagos puntuales. Capital One lo revisa a los 6 meses; Discover (donde es aceptado) lo hace a los 7 meses. Al graduarte, recibes de vuelta tu depósito, normalmente en un plazo de 7 a 10 días hábiles."
  - q: "¿Qué documentos necesito para solicitar una tarjeta de crédito asegurada con ITIN?"
    a: "Por lo general necesitarás: (1) tu carta de asignación del ITIN o el número en sí, (2) una identificación oficial vigente con foto, como un pasaporte extranjero o una matrícula consular, (3) comprobante de domicilio postal en EE. UU., un contrato de arrendamiento o una factura de servicios sirven, y (4) comprobante de ingresos, como talones de pago recientes o una declaración de impuestos. Algunos emisores exclusivamente en línea también pueden enviarte un código de un solo uso a un número de teléfono de EE. UU., así que ten a la mano un número celular real del país."
  - q: "¿Puedo solicitar una tarjeta de crédito asegurada con ITIN en línea, o tengo que ir a una sucursal?"
    a: "Depende del emisor. Capital One, Citi y algunos emisores fintech como OpenSky y Firstcard permiten solicitudes completamente en línea con un ITIN. Chase y Bank of America generalmente requieren que los solicitantes con ITIN visiten una sucursal en persona. Si el formulario en línea no acepta tu ITIN en el campo de SSN, llama a la línea de servicio al cliente del emisor y aplica por teléfono o en persona."
published: true
---
...
3. **Comprobante de domicilio postal en EE. UU.**, un contrato de arrendamiento firmado, una factura de servicios a tu nombre o un estado de cuenta bancario con tu dirección. La tarjeta física se enviará a esta dirección.
4. **Comprobante de ingresos**, talones de pago recientes, una carta de oferta de trabajo o una declaración de impuestos. Los emisores están obligados por ley a evaluar tu capacidad de pago.
5. **Un número de teléfono de EE. UU.**, muchas solicitudes en línea envían un código de un solo uso durante la verificación de identidad. Un número VoIP como Google Voice no pasará esta verificación; necesitas un número celular real de EE. UU.
6. **Una cuenta bancaria en EE. UU. con fondos**, necesitarás una forma de pagar el depósito de seguridad mediante transferencia ACH. Si aún no tienes una cuenta bancaria en EE. UU., abrirla primero es el paso cero.
