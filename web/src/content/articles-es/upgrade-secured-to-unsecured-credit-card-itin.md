...
relatedQueries:
  - "graduarse de tarjeta de crédito asegurada con ITIN"
  - "recuperar depósito de tarjeta de crédito asegurada con ITIN"
  - "cuándo cambiar tarjeta asegurada a no asegurada con ITIN"
  - "tarjeta asegurada a no asegurada sin SSN"
...
faqs:
  ...
  - q: "¿Cuánto tiempo tarda en concretarse el paso de una tarjeta asegurada a una no asegurada con ITIN?"
    a: "La mayoría de los emisores comienzan las revisiones automáticas después de 6 meses de actividad en la cuenta. Para los titulares de ITIN que parten de cero historial crediticio en Estados Unidos, el tiempo realista para hacer el cambio es de 12-18 meses, una vez que tu puntaje de crédito esté en el rango de 630-680 o más."
  - q: "¿Me devuelven el depósito de seguridad cuando hago el cambio?"
    a: "Por lo general, sí, siempre que el emisor ofrezca un cambio interno real (en el que el número de cuenta se mantiene igual). Si el emisor requiere que cierres la tarjeta asegurada y abras una nueva cuenta no asegurada, el depósito se devuelve después de pagar el saldo, normalmente dentro de 1-2 ciclos de facturación."
  - q: "¿Pasar de una tarjeta asegurada a una no asegurada afecta mi puntaje de crédito?"
    a: "Un cambio de producto interno real (misma cuenta, producto diferente) no genera una consulta dura y conserva la antigüedad de tu cuenta. Abrir una cuenta no asegurada nueva en un emisor diferente sí implica una consulta dura, pero agrega una nueva línea de crédito a tu historial, lo cual tiene sus propias ventajas y desventajas."
  - q: "¿Qué pasa si mi emisor no ofrece la opción de cambio?"
...
| Emisor / Tarjeta | Tipo de cambio | Plazo típico | ¿Consulta dura al hacer el cambio? | Devolución del depósito |
|---|---|---|---|---|
| Capital One Platinum Secured | Revisión automática; cambio de producto interno | Desde los 6 meses | No | Sí, acreditado a la cuenta |
| Discover it Secured | Revisión automática desde los 7 meses | 7-12 meses | No | Sí, devuelto tras el cambio |
| Bank of America Secured | Solicitud manual o revisión periódica | 12+ meses | Posible | Sí, al cierre o al hacer el cambio |
| Citi Secured Mastercard | Solicitud manual; cuenta nueva separada | 18+ meses | Sí (cuenta nueva) | Sí, después de pagar el saldo |
| OpenSky Secured | Opciones limitadas; posible tarjeta no asegurada relacionada | 6 meses (elegibilidad no definida) | Varía | Solo si se cierra la cuenta |
| Self Visa | Vinculada a una cuenta Credit Builder; sin cambio clásico | Continuo | No | Ahorros liberados al final del plazo |
