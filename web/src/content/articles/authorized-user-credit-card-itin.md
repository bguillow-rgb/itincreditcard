---
title: "Become an Authorized User With an ITIN (2026 Guide)"
description: "Yes, ITIN holders can become authorized users on U.S. credit cards, no SSN needed at most issuers. Learn which banks allow it, what gets reported, and how to use it to build credit fast."
tier: detail
targetQuery: "become authorized user on credit card with ITIN"
relatedQueries:
  - "can you be an authorized user without an SSN"
  - "authorized user credit card no SSN"
  - "does being authorized user build credit with ITIN"
  - "which credit cards add authorized users without SSN"
...
faqs:
  ...
  - q: "Does being an authorized user actually build credit with an ITIN?"
    a: "It can, but only if the issuer reports authorized user activity to the credit bureaus AND can match the account to your credit file. Major issuers like Amex, Chase, and Capital One report to all three bureaus. Once matched to your ITIN-linked file, the account's payment history, credit limit, and age all factor into your score."
  - q: "What happens to my credit if the primary cardholder misses a payment?"
    a: "Late payments on the primary account will appear on your credit report too, hurting your score. Choose a primary cardholder who pays on time and keeps their balance low. If the account turns negative, you can request to be removed, and the negative history will typically drop off your report within one to two billing cycles."
  - q: "Does Citibank require an SSN or ITIN to add an authorized user?"
    a: "Citibank can add an authorized user with just a name, birthday, and address. However, according to WalletHub, if you want the activity reported to the credit bureaus, you will need to also provide an SSN or ITIN. Without it, the account may not appear on your credit report at all."
  - q: "How long after being added as an authorized user will I see results on my credit report?"
    a: "Most issuers report account activity at the end of each monthly billing cycle. You should see the account appear on your credit report within 30-60 days of being added. If the primary card has years of on-time history, your score could jump meaningfully within that first reporting cycle."
  - q: "Can an authorized user be removed from an account, and what happens to the credit history?"
    a: "Yes. Either the primary cardholder or the authorized user can request removal by calling the issuer. Once removed, the account typically stops appearing on the authorized user's credit report within one to two billing cycles, including any positive history it had built."
published: true
---
