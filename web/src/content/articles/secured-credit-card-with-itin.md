---
title: "Secured Credit Card With an ITIN: Top Cards & How to Apply"
description: "Yes, you can get a secured credit card with an ITIN, no SSN needed. Compare the best ITIN-friendly cards and follow our step-by-step application guide."
tier: detail
targetQuery: "secured credit card with itin"
relatedQueries:
  - "how to apply for a credit card with an itin"
  - "credit cards that accept itin"
  - "best secured credit card for immigrants no ssn"
...
faqs:
  ...
  - q: "How much deposit do I need for a secured credit card with an ITIN?"
    a: "Most secured cards require a refundable deposit between $200 and $500, which becomes your credit limit. Capital One's Platinum Secured is available with as little as $49, $99, or $200 depending on your creditworthiness. The deposit is returned when you upgrade or close the account in good standing."
  - q: "Does using an ITIN instead of an SSN affect my credit score?"
    a: "No. The credit bureaus build and score your file the same way regardless of whether you used an ITIN or an SSN to open the account. Payment history, utilization, length of history, and credit mix all work identically."
  - q: "How long before my secured card graduates to an unsecured card?"
    a: "Most issuers review your account for an upgrade after 6-12 months of on-time payments. Capital One reviews at the 6-month mark; Discover (where accepted) reviews after 7 months. After graduating, you get your deposit back, typically within 7-10 business days."
  - q: "What documents do I need to apply for a secured credit card with an ITIN?"
    a: "You'll generally need: (1) your ITIN letter or number, (2) a valid government-issued photo ID such as a foreign passport or consular ID, (3) proof of a U.S. mailing address, a lease agreement or utility bill works, and (4) proof of income, such as recent pay stubs or a tax return. Some online-only issuers may also send a one-time passcode to a U.S. phone number, so have a real U.S. mobile number ready."
  - q: "Can I apply for a secured credit card with an ITIN online, or do I have to go to a branch?"
    a: "It depends on the issuer. Capital One, Citi, and some fintech issuers like OpenSky and Firstcard allow fully online applications with an ITIN. Chase and Bank of America typically require an in-person branch visit for ITIN applicants. If an online form won't accept your ITIN in the SSN field, call the issuer's customer line and apply by phone or in person."
published: true
---
...
|---|---|---|---|---|---|
| Capital One Platinum Secured | Capital One | $49-$200 | $0 | Yes | Yes |
| Capital One Quicksilver Secured | Capital One | $200 | $0 | Yes | Yes |
| Citi Secured Mastercard | Citi | $200 | $0 | Yes | Yes |
| Bank of America Customized Cash Secured | Bank of America | $300 | $0 | Yes | Yes |
| OpenSky Secured Visa | Capital Bank | $200 | $35/yr | Yes | Yes |
| Self Visa® Credit Card | Self | ~$100+ | $25/yr | Yes | Yes |
| Wells Fargo Secured Card | Wells Fargo | $300 | $0 | Yes | Branch only |
