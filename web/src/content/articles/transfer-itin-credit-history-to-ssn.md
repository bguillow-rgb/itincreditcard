---
title: "How to Transfer ITIN Credit History to Your New SSN"
description: "Got a new SSN? Your ITIN credit history won't move automatically. Here's the exact 3-step process to transfer your credit file to your Social Security number."
tier: detail
targetQuery: "how to transfer ITIN credit history to SSN"
relatedQueries:
  - "move credit history from ITIN to social security number"
  - "will my ITIN credit score transfer to SSN"
  - "notify credit bureaus of new SSN after ITIN"
  - "ITIN credit history lost when I got SSN"
  - "rescind ITIN after getting social security number"
quickAnswer: "Your ITIN credit history does not transfer automatically when you get an SSN. You must (1) notify the IRS to void your ITIN and combine tax records, (2) write to all three credit bureaus requesting the transfer, and (3) update your lenders. The process typically takes 30–60 days and should not hurt your credit score."
...
faqs:
  ...
  - q: "Will the transfer hurt my credit score?"
    a: "It should not. According to CreditCards.com, transferring your credit profile from an ITIN to an SSN should not affect your credit scores. Your account open dates and payment history stay exactly the same — only the identifier linking you to those records changes."
  - q: "How long does the ITIN-to-SSN credit transfer take?"
    a: "Plan for 30 to 60 days from the time the credit bureaus receive your written request. The IRS step — voiding your ITIN and combining tax records — can add a few additional weeks, so starting that process first is the smart move."
  - q: "Can I keep using my ITIN for credit after I receive an SSN?"
    a: "No. Once you are assigned an SSN, you must use it for all tax and financial purposes and stop using your ITIN. Per Harvard International Office guidance, using both simultaneously for tax filings is improper, and lenders who detect both identifiers on the same person may flag the account for fraud review."
  - q: "What documents do I need to send to the credit bureaus?"
    a: "You'll need: (1) a written letter identifying your old ITIN and new SSN, (2) a copy of your IRS confirmation letter voiding your ITIN, (3) a copy of your Social Security card, and (4) a recent utility bill or bank statement confirming your current address. Send these to Equifax, Experian, and TransUnion separately."
  - q: "What if my credit report doesn't show up when I search by SSN after the transfer?"
    a: "Give it a full 60 days after the bureaus acknowledge your request. If the file still isn't showing under your SSN, call each bureau's consumer assistance line and reference your case number. You can also use AnnualCreditReport.com to pull all three reports free of charge and verify the merge completed correctly."
published: true
---
...
If you're still in the process of building credit and haven't yet received an SSN, our guides on [which banks accept ITIN for credit cards](/which-banks-accept-itin-for-credit-cards) and [secured credit cards with an ITIN](/secured-credit-card-with-itin) cover the card options that will give you the strongest possible file to transfer when that day comes.
