---
title: "Credit Card Pre-Qualification With an ITIN (2026 Guide)"
description: "Yes, ITIN holders can pre-qualify for credit cards without a hard pull. Learn which issuers accept ITINs at the prequalification step and how to protect your credit."
tier: detail
targetQuery: "how to pre-qualify for a credit card with an ITIN"
relatedQueries:
  - "credit card pre-approval with ITIN no SSN"
  - "soft pull credit card ITIN holder"
  - "prequalify for credit card without social security number"
  - "ITIN credit card application no hard inquiry"
...
faqs:
  ...
  - q: "Does credit card pre-qualification hurt my credit score?"
    a: "No. Pre-qualification uses a soft credit inquiry, which has no impact on your credit score. A hard inquiry only happens when you formally submit a full application. Because ITIN holders may have thin credit files, protecting each inquiry matters more, so pre-qualifying before applying is especially worthwhile."
  - q: "Is pre-qualification the same as pre-approval?"
    a: "They are very similar and card issuers often use the terms interchangeably. Pre-qualification is typically consumer-initiated: you visit the issuer's site and submit basic information. Pre-approval is more often issuer-initiated (a mailer or online offer). In both cases, a soft pull is used and approval is not guaranteed until you formally apply."
  - q: "If I am pre-qualified, am I guaranteed to be approved?"
    a: "No. Pre-qualification signals a strong likelihood of approval but is not a guarantee. When you formally apply, the issuer runs a hard pull and reviews your full credit file, income, and other factors. That said, according to WalletHub, being pre-approved puts your approval odds at 90% or higher if you apply promptly and your situation has not changed."
  - q: "What information do I need to pre-qualify for a credit card with an ITIN?"
    a: "You typically need: your full legal name, U.S. mailing address, date of birth, your ITIN (9 digits, starting with 9), annual income, and housing payment amount. You do not need a Social Security number. Capital One's pre-qualification form specifically lists ITIN as an accepted alternative to an SSN."
published: true
---
...
| Issuer | ITIN Accepted at Pre-Qual? | Pre-Qual Tool | Notes |
|---|---|---|---|
| Capital One | Yes (explicit) | Online, 2-3 min | Lists ITIN as alternative to SSN |
| Chase | Yes | Online | ITIN accepted in application field |
| American Express | Yes | Online | Enter ITIN where SSN last 4 is requested |
| Bank of America | Yes (in-branch) | Limited online | ITIN accepted; branch visit may be required |
| Citi | Yes | Online pre-qual page | Existing banking relationship helps |
| OpenSky | N/A (no credit check) | Direct application | No credit check at all; ITIN accepted |
| Firstcard | N/A (pre-approved) | Direct application | ITIN, SSN, or passport accepted; no hard pull |
