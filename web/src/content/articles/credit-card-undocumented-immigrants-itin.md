---
title: "Credit Cards for Undocumented Immigrants With an ITIN (2026)"
description: "Yes, undocumented immigrants can get a credit card using an ITIN. See which issuers accept ITIN, what documents you need, and which cards are easiest to get approved for."
tier: detail
targetQuery: "can undocumented immigrants get a credit card with an ITIN"
relatedQueries:
  - "credit card for undocumented immigrants no SSN"
  - "ITIN credit card no immigration status required"
  - "credit card for undocumented person 2026"
  - "best credit card for undocumented immigrants ITIN"
...
faqs:
  ...
  - q: "What is the easiest credit card to get as an undocumented immigrant with an ITIN?"
    a: "Secured cards with no credit check are the most accessible. The OpenSky Secured Visa requires only a refundable deposit (minimum $200) and an ITIN, with no credit check at all. The Capital One Platinum Secured is another strong option that accepts ITIN applicants with no existing U.S. credit history."
  - q: "Can I get a credit card with only a passport and no ITIN?"
    a: "A small number of issuers, including some Bank of America branches, accept a foreign passport in place of both an SSN and an ITIN. However, applying with only a passport is much more restrictive, and the card may not report to all three credit bureaus. Getting an ITIN first expands your options significantly."
  - q: "Will my ITIN credit card report to the credit bureaus and help me build credit?"
    a: "Yes, as long as you choose a card that reports to all three bureaus (Experian, Equifax, and TransUnion). Most ITIN-accepting secured and unsecured cards do report to all three. Confirm with the issuer before applying. Cards that report to only one bureau build a thinner credit file."
  - q: "How long does it take to get an ITIN before I can apply for a credit card?"
    a: "The IRS processes ITIN applications (Form W-7) in approximately 7-11 weeks when mailed. Applying through a Certified Acceptance Agent (CAA) is the fastest route because you do not have to mail your original passport. Once you receive your ITIN, you can apply for a credit card the same day."
published: true
---
...
| Issuer | Accepts ITIN? | Best card for ITIN starters | Notes |
|---|---|---|---|
| Capital One | Yes | Platinum Secured / Quicksilver Secured | Pre-qualification tool available; no hard pull to check odds |
| Citi | Yes | Citi Secured Mastercard | Existing banking relationship helps approval odds |
| Bank of America | Yes (branch only for passport) | BofA Customized Cash Secured | Checking account with them improves approval chances |
| OpenSky | Yes | OpenSky Secured Visa | No credit check at all; best for zero U.S. credit history |
| American Express | Yes (ITIN required) | Blue Cash Everyday | Good credit history needed; ITIN accepted for all Amex cards |
| Petal | Yes | Petal 2 Cash Back Visa | Uses banking history to underwrite; no deposit needed |
