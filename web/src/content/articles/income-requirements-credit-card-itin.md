---
title: "Income Requirements for an ITIN Credit Card (2026 Guide)"
description: "Yes, ITIN holders need to show income for most credit cards. Learn what counts, how much, which issuers verify it, and how to apply with confidence."
tier: detail
targetQuery: "what income do you need to get a credit card with an ITIN"
relatedQueries:
  - "proof of income for credit card application ITIN holder"
  - "can I apply for a credit card with ITIN and no job"
  - "what documents do I need for a credit card with ITIN"
  - "minimum income for ITIN credit card approval"
...
faqs:
  ...
  - q: "What documents count as proof of income for an ITIN credit card application?"
    a: "Accepted documents commonly include recent pay stubs (2-3 months), bank statements showing regular deposits, the most recent federal tax return, an employer offer letter, or business income records if you are self-employed. The exact list varies by issuer, so confirm before you apply."
  - q: "Can I list my spouse's income on a credit card application if I have an ITIN?"
    a: "Yes, if you are 21 or older you can generally list household income you have reasonable access to, including a spouse's wages. Applicants ages 18-20 must show independent income only, per federal rules under the CARD Act."
  - q: "Can I get a credit card with an ITIN if I am self-employed or a freelancer?"
    a: "Yes. Self-employment income counts. You would typically show bank statements with consistent deposits, your most recent Schedule C or 1040, or recent invoices. Some issuers are more flexible with self-employed applicants if you have a banking relationship with them already."
  - q: "Do credit card issuers actually verify the income I report on my ITIN application?"
    a: "Not always upfront. Many issuers rely on self-reported income at the time of application and may request documentation later. However, knowingly overstating your income is considered fraud, so always report accurately. Issuers may request bank statements during a review or before raising your credit limit."
published: true
---
...
| Card | Income Flexibility | Deposit Required | Credit Check? | Issuer Accepts ITIN? |
|---|---|---|---|---|
| OpenSky Secured Visa | Very flexible, deposit covers risk | $200+ (refundable) | No | Yes |
| Capital One Platinum Secured | Moderate, $49-$200 deposit helps | $49, $99, or $200 | Yes (soft pre-qual available) | Yes |
| Petal 2 Visa | Uses bank cash flow, no hard income floor | None (unsecured) | Yes | Yes |
| Citi Secured Mastercard | Moderate, banking relationship helps | $200+ | Yes | Yes |
| Bank of America Secured | Moderate, existing account boosts odds | $200-$5,000 | Yes | Yes |
| Chase Freedom Rise | Moderate, no U.S. credit history required | None | Yes | Yes |
| Zolve Classic | Flexible, accepts offer letters and pay slips | None (unsecured) | Alternative underwriting | Yes (passport accepted too) |
