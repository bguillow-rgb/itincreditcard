---
title: "Store Credit Cards That Accept ITIN (2026 Guide)"
description: "Yes, some store credit cards accept an ITIN instead of an SSN. See which retail cards work for ITIN holders, approval tips, and how to use them to build U.S. credit."
tier: detail
targetQuery: "store credit card with itin"
relatedQueries:
  - "retail credit card itin no ssn"
  - "amazon credit card itin"
  - "can itin holders get store credit cards"
  - "best starter credit card itin no credit history"
...
faqs:
  ...
  - q: "Does Target's RedCard accept an ITIN?"
    a: "Target's RedCard credit product is issued by TD Bank, which does not currently publish a clear ITIN acceptance policy for its retail card. The RedCard debit version, which pulls directly from your bank account, has no credit check and is generally accessible without an SSN. If you want the credit version, call TD Bank directly before applying to confirm their current policy."
  - q: "Does the Amazon store card accept ITIN?"
    a: "The standard Amazon Store Card (Synchrony) has not consistently accepted ITIN in verified reports. The Amazon Secured Card, also issued by Synchrony, is specifically designed for thin-credit applicants and has been confirmed to work with ITIN. It requires a refundable deposit of $100-$1,000 and reports to all three bureaus."
  - q: "Will applying for a store credit card hurt my credit score if I have an ITIN?"
    a: "Yes, any hard inquiry can temporarily lower your score by a few points, whether you have an SSN or ITIN. If you have no U.S. credit file yet, the impact is minimal because there is no established score to affect. Limit applications to one card at a time, especially in your first 12 months, to avoid stacking inquiries."
  - q: "What is a closed-loop vs. open-loop store credit card, and which is easier to get with an ITIN?"
    a: "A closed-loop card works only at the issuing retailer (e.g., an Amazon-only card). An open-loop card carries a Visa or Mastercard logo and works anywhere. Closed-loop secured cards tend to be easier to obtain with an ITIN because approval requirements are less stringent. Open-loop co-branded cards often require a stronger credit profile, but issuers like Capital One that accept ITIN make them accessible after 6-12 months of credit building."
  - q: "Do store credit cards report to credit bureaus if I use my ITIN?"
    a: "Most major retail card issuers report to all three bureaus (Equifax, Experian, TransUnion) regardless of whether the account was opened with an SSN or ITIN. Always confirm with the issuer before applying. Reporting is what builds your credit file, so choose cards that explicitly report to all three."
published: true
---
...
| Card | Issuer | Card Type | ITIN Accepted | Deposit Required | Reports to All 3 Bureaus |
|---|---|---|---|---|---|
| Amazon Secured Card | Synchrony Bank | Closed-loop secured | Yes (confirmed) | $100-$1,000 | Yes |
| Capital One co-branded cards (Walmart, etc.) | Capital One | Open-loop | Yes (issuer-level policy) | No (unsecured) | Yes |
| OpenSky Secured Visa | Capital Bank | General secured | Yes (no SSN needed) | $200 min | Yes |
| Petal 2 Visa | WebBank | Open-loop unsecured | Yes (ITIN accepted) | No | Yes |
| Target RedCard Credit | TD Bank | Open-loop | Not confirmed | No | Yes |
| Walmart Rewards Card (Capital One) | Capital One | Open-loop | Yes (Capital One policy) | No | Yes |
