---
title: "First Credit Card With an ITIN and No U.S. Credit History"
description: "Yes, you can get your first U.S. credit card with an ITIN and zero credit history. See which cards approve newcomers, what docs you need, and how to apply."
tier: detail
targetQuery: "first credit card with itin no us credit history"
relatedQueries:
  - "credit card for immigrants with no credit history"
  - "how to get approved for credit card with itin no credit"
  - "best first credit card for newcomers itin"
  - "credit card no ssn no credit history immigrant"
...
faqs:
  ...
  - q: "What documents do I need to apply for my first ITIN credit card?"
    a: "You typically need your ITIN letter from the IRS, a valid foreign passport or government-issued photo ID, proof of a U.S. mailing address (such as a utility bill or lease), and proof of income (recent pay stubs, bank statements, or tax returns)."
  - q: "How long does it take to get a credit score after opening my first ITIN card?"
    a: "According to CNBC Select, it generally takes two to six months of credit activity to generate a scoreable file with U.S. credit bureaus. After that window, your on-time payments will begin producing a FICO score you can use for future card applications."
  - q: "Should I use a secured card or a no-deposit credit-builder card as my first ITIN card?"
    a: "Both work. A secured card (like Capital One Quicksilver Secured or Citi Secured Mastercard) requires a refundable deposit of $200 or more and gives you a traditional credit line. A no-deposit option like the OpenSky Secured skips the credit check but still needs a deposit. If cash is tight, a no-deposit credit-builder card with ITIN acceptance is a valid alternative."
  - q: "Will my foreign credit history help me get approved for a U.S. credit card?"
    a: "It can. American Express accepts international credit history through Nova Credit's Credit Passport for applicants from supported countries including India, Mexico, Canada, the UK, and others. Chase also partners with Nova Credit. However, Nova Credit does not create a U.S. credit score on its own -- you still need a U.S. card reporting to the bureaus to build a local credit file."
  - q: "How many ITIN credit cards should I apply for at once?"
    a: "Apply for one card at a time. Each full application triggers a hard inquiry on your credit report. Spacing applications at least six months apart avoids stacking hard pulls when your file is still thin, which can temporarily lower your score."
published: true
---
...
1. **Your ITIN letter from the IRS.** This is the official notice the IRS mailed when your ITIN was assigned. Most issuers ask you to enter the nine-digit number, but some request proof if flagged for review.
2. **A valid photo ID.** When applying, have your ITIN, a valid form of ID (passport or consular ID), proof of address, and proof of income ready.
3. **Proof of a U.S. mailing address.** A physical street address is required -- not a P.O. box. A utility bill, lease agreement, or bank statement works. Cards are mailed to this address.
4. **Proof of income.** You'll need to show income to prove you can make payments, typically through pay stubs, bank statements, or tax returns.
...
1. **Use a pre-qualification tool first.** Before you apply for credit cards, you may want to try getting pre-approved to see which cards you could be eligible for. Pre-approval typically involves a soft inquiry, which means it won't affect your credit scores. Capital One's pre-qualify tool is especially newcomer-friendly.
2. **Pick one card and apply.** Select a card from the table above that matches your cash situation. If you have $200 available for a deposit, the Capital One Quicksilver Secured or Citi Secured Mastercard are strong picks. If you want to skip the credit check entirely, OpenSky is your clearest option.
3. **Enter your ITIN where the form asks for an SSN.** Some online forms display this option only after you select an alternate ID type. If the form will not accept an ITIN, call the issuer's customer line and apply by phone.
4. **Fund your deposit promptly.** For secured cards, the account does not open until the deposit is received. Having a U.S. bank or fintech account with routing and account number is a must so you can fund via ACH within the issuer's window.
