---
title: "2026 Executive Order & ITIN Credit Cards: What Changes Now"
description: "Yes, you can still apply for a credit card with an ITIN in 2026, but EO 14406 adds new scrutiny. Here's exactly what changes, what doesn't, and what to do now."
tier: detail
targetQuery: "how does the 2026 executive order affect ITIN credit card applications"
relatedQueries:
  - "ITIN credit card application 2026 executive order"
  - "can I still get a credit card with ITIN after Trump executive order"
  - "EO 14406 ITIN banking credit card impact"
  - "ITIN flagged as risk factor credit card application"
  - "what happens to my ITIN credit card after new banking rules 2026"
quickAnswer: "You can still apply for a credit card with an ITIN in 2026. Executive Order 14406 (signed May 19, 2026) instructs banks to treat ITIN use as a potential due-diligence trigger, not an automatic denial. Key regulatory guidance from Treasury is due July 18, 2026. Lawful-status ITIN holders face the least risk; strong documentation helps most."
...
faqs:
  ...
  - q: "Which ITIN holders are most affected by EO 14406 when applying for a credit card?"
    a: "Undocumented applicants without verified lawful status face the highest scrutiny under the new order. ITIN holders with a valid visa, green card, EAD, or other proof of lawful presence are in a stronger position because the order specifically targets applicants who 'lack verified lawful immigration status.'"
  - q: "Will my existing ITIN credit card be closed because of the executive order?"
    a: "The order does not mandate closures of existing accounts. Banks have not yet received final Treasury guidance, so proactively closing accounts is not recommended. Monitor issuer communications, keep your account in good standing, and document your tax and payment history."
  - q: "What documents should I bring to a credit card application now that the EO is in effect?"
    a: "Bring your ITIN letter, a valid passport or government-issued ID, proof of lawful presence (visa, EAD, or green card if applicable), proof of U.S. address, and proof of income (pay stubs or bank statements). Stronger documentation reduces the chance of an enhanced-review delay."
  - q: "Are credit unions safer than big banks for ITIN credit card applicants under the new rules?"
    a: "Community credit unions and CDFIs that serve immigrant populations may implement new federal guidance more slowly than large national banks, according to immigration finance analysts. They are not exempt from the rules, but their existing relationships with ITIN borrowers may make them more flexible in practice."
  - q: "What is the Treasury advisory deadline and why does it matter for my credit card application?"
    a: "The Treasury's formal advisory identifying ITIN-related 'red flags' for banks was due July 18, 2026 (60 days after the May 19 signing). Once issued, it shapes how bank compliance teams handle ITIN applications in practice, even though it is not legally binding on its own."
published: true
---
...
|---|---|
| July 18, 2026 | Treasury issues formal advisory with ITIN red-flag typologies for banks |
| July 18, 2026 | CFPB considers whether deportation risk affects ability-to-repay rules |
| August 17, 2026 | Treasury proposes BSA rule changes allowing banks to collect immigration-status data when risk warrants it |
| November 15-16, 2026 | Treasury and regulators review customer ID program rules covering foreign consular IDs |
...
| Issuer / Card | Accepts ITIN? | Notes for 2026 |
|---|---|---|
| Capital One (Platinum Secured, Quicksilver Secured) | Yes | Immigrant-friendly history; pre-qualification tool available |
| Bank of America (Customized Cash Secured) | Yes | Existing banking relationship improves odds significantly |
| Citi (Secured Mastercard) | Yes | Stronger odds with existing Citi relationship |
| OpenSky Secured Visa | Yes | No credit check; ITIN accepted; strong pick if lawful status uncertain |
| Self Visa (Credit Builder) | Yes | No hard pull at application; good for thin-file applicants |
| Credit unions / CDFIs | Varies | May implement new federal guidance more slowly than big banks |
