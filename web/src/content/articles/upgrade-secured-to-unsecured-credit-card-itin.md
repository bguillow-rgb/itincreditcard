---
title: "Upgrade Secured to Unsecured Credit Card With an ITIN (2026)"
description: "Yes, ITIN holders can graduate from a secured to an unsecured credit card. Learn which issuers offer upgrade paths, when to ask, and how to get your deposit back."
tier: detail
targetQuery: "how to upgrade from secured to unsecured credit card with ITIN"
relatedQueries:
  - "graduate secured credit card with ITIN"
  - "get deposit back secured credit card ITIN"
  - "when to upgrade secured credit card ITIN holder"
  - "secured card to unsecured card no SSN"
...
faqs:
  ...
  - q: "How long does it take to graduate from a secured to an unsecured credit card with an ITIN?"
    a: "Most issuers begin automatic reviews after 6 months of account activity. A realistic upgrade window for ITIN holders starting from zero U.S. credit history is 12-18 months, once your credit score is in the 630-680 range or higher."
  - q: "Will I get my security deposit back when I upgrade?"
    a: "Usually yes, if your issuer offers a true in-place upgrade (the account number stays the same). If the issuer requires you to close the secured card and open a new unsecured account, the deposit is returned after the balance is paid off, typically within 1-2 billing cycles."
  - q: "Does upgrading from secured to unsecured hurt my credit score?"
    a: "A true in-place product change (same account, different product) does not trigger a hard inquiry and preserves your account age. Opening a brand-new unsecured account at a different issuer involves a hard inquiry but adds a new tradeline, which has its own trade-offs."
  - q: "What if my issuer does not offer an upgrade path?"
...
| Issuer / Card | Upgrade Type | Typical Timeline | Hard Inquiry on Upgrade? | Deposit Return |
|---|---|---|---|---|
| Capital One Platinum Secured | Automatic review; true product change | As early as 6 months | No | Yes, credited to account |
| Discover it Secured | Automatic review starting at 7 months | 7-12 months | No | Yes, refunded after upgrade |
| Bank of America Secured | Manual request or periodic review | 12+ months | Possible | Yes, on close or upgrade |
| Citi Secured Mastercard | Manual request; separate new account | 18+ months | Yes (new account) | Yes, after balance paid |
| OpenSky Secured | Limited path; related unsecured card possible | 6 months (eligibility unclear) | Varies | Only if account closed |
| Self Visa | Paired with Credit Builder Account; no classic upgrade | Ongoing | No | Savings released at term end |
