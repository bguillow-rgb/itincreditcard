...
description: "Yes, ITIN holders can check their credit score, but not at AnnualCreditReport.com. Here's exactly how to pull your report from all 3 bureaus without an SSN."
tier: detail
targetQuery: "how to check credit score with itin"
relatedQueries:
  - "check credit report with itin number"
  - "itin credit score experian equifax transunion"
  - "can itin holders use annualcreditreport.com"
  - "credit monitoring for itin holders"
  - "itin credit score range"
quickAnswer: "ITIN holders can check their credit score, but the standard AnnualCreditReport.com portal requires an SSN. Instead, request your report directly from Experian (by mail or phone), Equifax (online via myEquifax), or TransUnion (by mail, phone, or live chat). All three bureaus accept ITIN as your identifier."
...
faqs:
  ...
  - q: "Does my credit score work the same way with an ITIN as with an SSN?"
    a: "Yes. ITIN credit scores use the identical FICO and VantageScore models as SSN-based scores. Your score is calculated from payment history, credit utilization, length of history, credit mix, and new inquiries, not from which identifier you hold. Having an ITIN instead of an SSN does not lower your score."
  - q: "How long does it take to get a credit score after opening my first account with an ITIN?"
    a: "Most credit bureaus can generate a score after 3-6 months of positive account activity on file. You need at least one account reporting on-time payments before a score is calculated. Significant improvements typically take 12-18 months of consistent, responsible use."
  - q: "Will requesting my own credit report hurt my score?"
    a: "No. Requesting your own report is a soft inquiry and has zero impact on your credit score. Only hard inquiries, triggered when a lender checks your credit for an application, temporarily affect your score. Checking your own report as often as you like is safe and encouraged."
  - q: "What if I later receive an SSN, will my ITIN credit history transfer?"
    a: "Yes. If you receive an SSN after building credit under your ITIN, you can contact each bureau and request that your credit files be merged under your new SSN. Your full payment history carries over, you do not lose the credit history you built with your ITIN."
published: true
---
...
If you have opened a [secured credit card with your ITIN](https://itincreditcard.com/secured-credit-card-with-itin) and made at least 3-6 months of on-time payments, there is a very good chance a credit file already exists in your name.
...
| Bureau | Online Option | Mail | Phone |
|---|---|---|---|
...
For ITIN holders who are actively [building credit](https://itincreditcard.com/how-to-build-credit-with-itin), combining a reporting credit card with rent reporting is one of the most effective ways to accelerate your score in the first 12 months.

## What documents do I need to pull my credit report by mail?

Every mail-based bureau request needs the same core package:

1. **A written request letter** stating your full legal name and that you are requesting your free credit report under the Fair Credit Reporting Act (FCRA).
2. **A copy of a government-issued photo ID**, a passport, state ID, or driver's license.
3. **Proof of current address**, a utility bill, bank statement, or lease agreement dated within the past 60 days.
4. **Your full identifying information in the letter:** ITIN, date of birth, and all addresses from the past two years.
