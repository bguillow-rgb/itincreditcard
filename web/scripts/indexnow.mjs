...
// submitting nothing. Pinging the live sitemap is also the more correct thing
// to do for a post-deploy job: it submits what is actually published.
//
...
const KEY = '62731beede9e26ca35e66e302b5fc506';
const HOST = 'itincreditcard.com';
...
if (!urlList.length) {
  console.error('IndexNow: sitemap parsed but contained no <loc> entries.');
  process.exit(1);
}
